export const metadata = {
  title: "Manufacturing Services | HealthGuard Pharmaceuticals",
  description: "Explore our contract manufacturing (CDMO), formulation development, and analytical testing services.",
};
